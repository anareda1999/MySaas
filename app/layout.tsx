...
export const metadata: Metadata = {
  title: "NovaSaaS - Plateforme de Croissance & Analytics Intelligente",
  description: "Boostez vos revenus et automatisez vos flux de travail avec la plateforme SaaS tout-en-un de nouvelle génération.",
};
